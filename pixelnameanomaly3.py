...
square_width =  52#int(window_width/9)
    ...
    for xc in range(51):
        for yc in range(77):
            ...
            if RED != (255,255,255):
                ...
                if ran_speed < 5: ran_speed1 = random.randint(5,10) # y cannot be 9 why? Maybe mathematics
                else:  ran_speed1 = random.randint(1,5)
