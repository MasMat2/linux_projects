...
pygame.display.set_caption('Crazy points men')
...
for i in range(500):
    ...
    le = 2
    bouncers.append({'rect':pygame.Rect(x, y, random.choice([le]), random.choice([le])), 'dir':direction, 'color':color, 'speed':10, 'speed1':10})
...
while True:
    ...
    for bouncer in bouncers:
        ...
        if (bouncer['rect'].top < 0 or bouncer['rect'].right > window_width or
           ...
           bouncer['speed'] = random.randint(5,6)
           bouncer['speed1'] = random.randint(5,7)
