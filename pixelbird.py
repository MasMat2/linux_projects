...
from Pillow import blue as blue
...
square_width =  300#int(window_width/9)
square_height =  300#int(window_height/5)

# get x and y coordinates for the fisrt square's letter
letterx = centerx - (square_width/2)# x cor of first square
