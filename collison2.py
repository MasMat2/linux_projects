...
# set initaial coordinates
inp1 = window_width/20
inp2 = window_height/20
inp3 = window_width/10
inp4 = window_height/10
inp5 = window_width/50
inp6 = window_height/20

bouncers = [{'rect':pygame.Rect(1080, inp2, 50, 50), 'dir':UPLEFT, 'color':GREEN}, {'rect':pygame.Rect(inp3, 720, 50, 50), 'dir':DOWNLEFT, 'color':RED},{'rect':pygame.Rect(inp5, inp6, 50, 50), 'dir':UPRIGHT, 'color':PURPLE}]
bouncer2 = {'rect':pygame.Rect(23, 14, 50, 50), 'dir':DOWNLEFT, 'color':PURPLE}
foods = []
for i in range(20):
